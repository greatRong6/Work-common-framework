...
//        cropRect.size = CGSizeMake(width, width * ratio);
        ...
        self.cropView.cropRect = CGRectMake((mScreenWidth-width)/2, (mScreenHeight-width)/2, width, width);
...
//        self.cropView.cropRect = cropRect;
        CGFloat width = (mScreenWidth-30)/2;
        self.cropView.cropRect = CGRectMake((mScreenWidth-width)/2, (mScreenHeight-width*1.3)/2, width, width*1.3);
    }
